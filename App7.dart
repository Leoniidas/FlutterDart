...
class _HomeState extends State<Home> {
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                padding(text('Limite', 20, Colors.orange), 0, 20, 240, 0),
                padding(slider(), 0, 0, 0, 0),
                Row(children: <Widget>[
                  padding(text('Brasileiro', 20, Colors.orange), 20, 0, 0, 0),
                  switchy(),
                ]),
                button(),
                animatedContainer(),
  ...
  textfield(TextInputType input, String text, double FontSize,
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        hintText: text,
        hintStyle: TextStyle(fontSize: FontSize, color: Colors.orange),
  ...
  button() {
    return ElevatedButton(
        ...
        child: text('Confirmar', 20, Colors.white));
  }
  ...
  animatedContainer() {
    return AnimatedContainer(
      ...
      color: confirmed ? Colors.white : Colors.orange,
      alignment: Alignment.center,
      curve: Curves.fastLinearToSlowEaseIn,
      child: Column(children: <Widget>[
        Align(
            alignment: Alignment.topCenter,
            child: text('Conta Cadastrada', 25, Colors.white)),
        padding(align(text(saved_name, 20, Colors.white)), 10, 10, 0, 0),
        padding(align(text(saved_age, 20, Colors.white)), 10, 5, 0, 0),
        padding(align(text(saved_sex, 20, Colors.white)), 10, 5, 0, 0),
        padding(align(text(saved_school, 20, Colors.white)), 10, 5, 0, 0),
        padding(align(text(saved_limit, 20, Colors.white)), 10, 5, 0, 0),
        padding(align(text(origin, 20, Colors.white)), 10, 5, 0, 0),
      ]),
    );
  }
